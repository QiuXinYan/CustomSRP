...
public class SRP002Pipeline : RenderPipeline
{
    ...
    /// <summary>
    /// 着色器标签ID用于引用着色器中的各种名称，"SPR002_PBR_Pass"
    /// </summary>
    /// <returns></returns>
    private static ShaderTagId s_shaderTagId = new ShaderTagId("SPR002_PBR_Pass");
